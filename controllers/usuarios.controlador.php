...
class ControladorUsuarios{
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingUsuario"]) &&
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar){
					...
					{
						echo '<br><div class="alert alert-danger">Error al ingresar, proveedor vuelve a intentarlo</div>';
					}
	...
	static public function ctrUsuariosActivados($item, $valor){

		$tabla = "usuarios";
		$respuesta = ModeloUsuarios::MdlUsuariosActivados($tabla, $item, $valor);
		return $respuesta;
	}

	static public function ctrUsuariosNoActivados($item, $valor){
